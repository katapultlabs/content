# From Ideas to Collaborative Assets

**For product leaders, founders, and collaborators at Katapult**
...
1. **Have the idea.** You're excited. You haven't slept. Great.
2. **Open Claude, Cowork, or Wispr.** Talk to it the same way you'd talk to a co-founder. Say: *"Let's document a go-to-market strategy. Here's what I'm thinking..."*
3. **Let the AI structure it.** It will ask good questions. It will organize your thoughts into sections, user stories, or strategy frameworks. Go back and forth until it captures what's in your head — with full fidelity.
4. **Save the output as a concrete asset** — a PRD, a strategy brief, a positioning doc.
5. **Put it where the team can find it.** Linear, the project repo, or the shared knowledge base for the venture.
6. **Then tell the team.** Your standup message becomes: *"I wrote up the new positioning strategy — it's in Linear. Take a look and let me know your questions."*
